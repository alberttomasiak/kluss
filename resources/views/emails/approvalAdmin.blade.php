...
<html>
    ...
    <body>
        ...
        .mail-body p{ text-align: left; margin-left: 1em; font-size: .9em; line-height: 1.2em; margin-top: 1em; margin-bottom: 1em; max-width: 225px; display: block; margin-left: auto; margin-right: auto;}
        .mail-body a{ display: block; background-color: #2e9c4e; margin-bottom: 2em; margin-top: 2em; width: 175px; color: white; font-size: .9em; font-weight: bold; text-transform: uppercase; text-decoration: none; padding-top: 1em; padding-bottom: 1em; border-radius: 5px; display: block; margin-left: auto; margin-right: auto;}
        ...
        <div class="mail-wrap">
            ...
            <div class="mail-body">
                <h2>Nieuw klusje aangemaakt voor goedkeuring.</h2>
                <p>Gebruiker: {{$user}}</p>
                <p>Titel: {{$title}}</p>
