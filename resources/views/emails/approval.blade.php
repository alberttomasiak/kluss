...
<html>
    ...
    <body>
        ...
        <div class="mail-wrap">
            ...
            <div class="mail-body">
                <h2>Uw klusje verwacht goedkeuring!</h2>
                <p>Hey {{$user}}, je hebt onlangs een nieuwe klusje aangemaakt, {{$taskTitle}}. Omdat deze tot de categorie 'Overige' behoort moeten we deze nakijken.</p>
                <p>Maak je wel geen zorgen, we hebben onze beheerders meteen een seintje gegeven dat uw klusje goedkeuring nodig heeft! Eens we deze bevestigd hebben ga je een mailtje van ons ontvangen. Verwacht een antwoord binnen een paar dagen.</p>
