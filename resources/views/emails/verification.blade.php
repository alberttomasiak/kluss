...
<html>
    ...
    <body>
        ...
        body { font-family: sans-serif; background-color: #eee; width: 100; height: 100;}
        ...
        .mail-body p{ font-size: .9em; line-height: 1.2em; margin-top: 3em; margin-bottom: 2em; max-width: 225px; display: block; margin-left: auto; margin-right: auto;}
        ...
        footer{ display: block; width: 100%; background-color: #2e9c4e; color: white; text-align: center; height: 75px;}
