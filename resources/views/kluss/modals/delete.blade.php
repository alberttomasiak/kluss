  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content task-report-modal">
      ...
      <div class="modal-body">
          <form action="/kluss/{{$kl->id}}/verwijderen" name="kluss-verwijderen" id="kluss-verwijderen" method="post">
              {!! csrf_field() !!}
      ...
      <div class="modal-footer">
        ...
        <button type="submit" form="kluss-verwijderen" class="btn btn-danger">Verwijderen</button>
        </form>
      </div>
    </div>
  </div>
